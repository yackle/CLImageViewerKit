...
- (UIImage*)boxBlur:(CGFloat)blurLevel
{
    ...
    error = vImageBoxConvolve_ARGB8888(&inBuffer, &outBuffer, NULL, 0, 0, boxSize, 1, NULL, kvImageEdgeExtend) ? :
    vImageBoxConvolve_ARGB8888(&outBuffer, &inBuffer, NULL, 0, 0, 1, boxSize, NULL, kvImageEdgeExtend)?:
    vImageBoxConvolve_ARGB8888(&inBuffer, &outBuffer, NULL, 0, 0, boxSize, 1, NULL, kvImageEdgeExtend)?:
    vImageBoxConvolve_ARGB8888(&outBuffer, &inBuffer, NULL, 0, 0, 1, boxSize, NULL, kvImageEdgeExtend)?:
    vImageBoxConvolve_ARGB8888(&inBuffer, &outBuffer, NULL, 0, 0, boxSize, 1, NULL, kvImageEdgeExtend)?:
    vImageBoxConvolve_ARGB8888(&outBuffer, &inBuffer, NULL, 0, 0, 1, boxSize, NULL, kvImageEdgeExtend);
    outBuffer = inBuffer;
